...
def main():
    ...
    try:
        ...
        command([node, HERE / 'build.mjs', bend, HERE / 'prior.bend', out / 'prior.mjs'], out, 'compile')
        ...
        assert negative['stage'] == 'typecheck' and 'false_identical_protection' in negative['error']
        command([node, HERE / 'evaluate.mjs', out / 'prior.mjs', HERE / 'config.json', out / 'records.jsonl'], out, 'evaluate')
